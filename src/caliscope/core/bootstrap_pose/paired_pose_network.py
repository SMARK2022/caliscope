    ...
    def _build_anchored_config(
        ...
        for cam_id, cam_data in camera_array.cameras.items():
            configured_cameras[cam_id] = CameraData(
                ...
                original_filename=cam_data.original_filename,
                intrinsic_video=cam_data.intrinsic_video,
                extrinsic_video=cam_data.extrinsic_video,
                intrinsics_source=cam_data.intrinsics_source,
